  ...
  function requestSerahTerima() {
    ...
    setPendingAction(() => async (pin: string, kasir: string) => {
      try {
        ...
        const json = await res.json();
        if (json.ok) { setSelected(new Set()); loadSita(); loadAset(); loadBast(); }
        ...
        {activeTab === 2 && (
          <>
            ...
            <div className="tbl-wrap">
              <table>
                <thead><tr>
                  <th>No BA</th><th>No Faktur</th><th>Barang</th><th>Kategori</th>
                  <th className="num">Modal</th><th>Tgl Masuk</th><th>Status</th>
                </tr></thead>
                <tbody>
                  {asetLoading ? (
                    <tr><td colSpan={7} className="empty-state">⏳ Memuat...</td></tr>
                  ) : asetRows.length === 0 ? (
                    <tr><td colSpan={7} className="empty-state">Tidak ada aset</td></tr>
              ...
              <table>
                ...
                <tbody>
                  {jualLoading ? (
                    ...
                    <tr><td colSpan={7} className="empty-state">Belum ada riwayat</td></tr>
              ...
              <table>
                ...
                <tbody>
                  {bastLoading ? (
                    ...
                    <tr><td colSpan={5} className="empty-state">Belum ada BAST</td></tr>
